...
def test_retrainingOLD(model, test_idx, iter_to_load, force_refresh=False, 
...
def get_train_influences(model, test_idx, iter_to_load, force_refresh=False, 
                    num_steps=1000, random_seed=17, num_to_remove=0, 
                    remove_type='consistent', predict_all_train=False):
